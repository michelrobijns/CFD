...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering{\includegraphics[width=0.95\linewidth]{Images/streamFunction.pdf}}
	    \caption{$N = 64$}
    	\label{fig:sfb}
    \end{subfigure}
...
\begin{figure}[p]
    ...
    % This comment avoids line break...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering{\includegraphics[width=0.95\linewidth]{Images/vorticity.pdf}}
	    \caption{$N = 64$}
	    \label{fig:vb}	
    \end{subfigure}
...
\begin{figure}[p]
    ...
    % This comment avoids line break...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering{\includegraphics[width=0.95\linewidth]{Images/pressure.pdf}}
	    \caption{$N = 64$}
	    \label{fig:pressureb}	
    \end{subfigure}
